# -*- coding: utf-8 -*-
"""
Растровое поле "расстояние до берега со знаком" (км) для региона Пиренейский
п-ов + Балеары (тот же REGION_LONLAT, что у "слоя 4", см.
scripts/tools/bake_provinces_iberia_tiles.py). Море — положительное
расстояние, суша — ОТРИЦАТЕЛЬНОЕ (нужно, чтобы полоса "мелководье" могла
заходить на 1 км вглубь суши, не только в море — решение пользователя
2026-07-10, второй заход: 3 уровня моря — мелководье (фикс. полоса
-1..+10 км от берега)/шельф/глубины моря, см.
scripts/SeaZonesLayer.gd).
...
# Тот же регион, что REGION_LONLAT в bake_provinces_iberia_tiles.py ("слой 4").
...
OUT_PNG = "assets/generated/coast_distance_field_iberia.png"
