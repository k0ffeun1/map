...
формы русла реки) — забираем прибрежный кусок земли у "Cádiz"/"Huelva"
в районе устья Гвадалквивира и присоединяем его к "Sevilla".
(2026-07-13: имена в assets/provinces.json починены от двойной UTF-8-кодировки,
поэтому здесь теперь нормальное "Cádiz", а не "CÃ¡diz" как раньше.)
...
# граница клина сама упрётся в настоящую береговую линию Huelva/Cádiz.
WEDGE_LONLAT = (-6.55, 36.75, -6.05, 37.15)  # (lon_min, lat_min, lon_max, lat_max)

SEVILLA_NAME = "Sevilla"
DONOR_NAMES = ["Cádiz", "Huelva"]
