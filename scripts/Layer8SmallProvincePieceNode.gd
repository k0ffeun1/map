extends Node2D
## Lightweight polygon used by Layer8SmallProvinceViewer.

var _rings: Array = []
var _fill_color := Color.TRANSPARENT
var _outline_color := Color.WHITE
var _outline_width := 0.9


func setup(p_rings: Array, p_fill: Color, p_outline: Color, p_width: float = 0.9) -> void:
	_rings = p_rings
	_fill_color = p_fill
